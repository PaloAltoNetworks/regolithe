...
func TestAttribute_Validate(t *testing.T) {
	...
	Convey("Given I have an attribute signed and transient", t, func() {
		...
		Convey("When I call validate", func() {
			...
			Convey("Then there should be validation error", func() {
				So(len(errs), ShouldEqual, 1)
				So(errs[0].Error(), ShouldEqual, "spec.spec: attribute 'name' cannot be use for signature if it is autogenerated, transient, read only or not exposed")
			})
		})
	})

	Convey("Given I have an attribute signed and autogenerated", t, func() {
	...
	Convey("Given I have an attribute signed and read_only", t, func() {
