...
func regoAbstractJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "rego-abstract.json", size: 6849, mode: os.FileMode(420), modTime: time.Unix(1521750306, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func regoSpecJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "rego-spec.json", size: 12448, mode: os.FileMode(420), modTime: time.Unix(1521750306, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
