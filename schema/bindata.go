...
func regoAbstractJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "rego-abstract.json", size: 9559, mode: os.FileMode(420), modTime: time.Unix(1524508826, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func regoSpecJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "rego-spec.json", size: 15157, mode: os.FileMode(420), modTime: time.Unix(1524508826, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
