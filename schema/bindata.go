...
func regoAbstractJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "rego-abstract.json", size: 9329, mode: os.FileMode(420), modTime: time.Unix(1522184133, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func regoSpecJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "rego-spec.json", size: 14927, mode: os.FileMode(420), modTime: time.Unix(1522184133, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
